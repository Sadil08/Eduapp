...
public class PaperBundleSummaryDto {
    ...
    public PaperBundleSummaryDto(Long id, String name, String description, BigDecimal price, PaperType type,
            Long examTypeId, String examTypeName, Long subjectId, Long lessonId, Boolean isPastPaper) {
        this.id = id;
        this.name = name;
